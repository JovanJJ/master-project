...
export default function WorkerAccountHtml({ lang, data, profileImage }) {
                ...
                <div className="mx-auto w-full max-w-[1000px] p-6 rounded-3xl shadow-2xl bg-blue-50">
                    ...
                    <div className="w-full flex justify-center pt-7">
                        <div className="w-2/3 max-w-48 aspect-square rounded-full relative border-3 border-blue-200">
                            ...
                            />
                            <div className="absolute w-[50px] h-[50px] bottom-10 right-10 z-30 sm:-bottom-5 sm:-right-5 md:-bottom-1 md:-right-5 lg:bottom-1 lg:right-1">
