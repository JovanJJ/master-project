    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">Top Rated Professionals</h2>
          <p className="mt-4 text-lg text-gray-600">Check out some of our highly-reviewed workers.</p>
        </div>
